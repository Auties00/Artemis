...
class AnimeController {
    ...
    private let seriesCacheLock: NSLock
    private var seasonsCache: [Int:Task<Season, Error>]
    private let seasonsCacheLock: NSLock
    private var playlistsCache: [Int:Task<Playlist, Error>]
    private let playlistsCacheLock: NSLock
    private var episodeCache: [Int:Task<Episode, Error>]
    private let episodeCacheLock: NSLock
    init(apiController: ApiController) {
        self.apiController = apiController
        self.seriesCache = [:]
        self.seriesCacheLock = NSLock()
        self.seasonsCache = [:]
        self.seasonsCacheLock = NSLock()
        self.playlistsCache = [:]
        self.playlistsCacheLock = NSLock()
        self.episodeCache = [:]
        self.episodeCacheLock = NSLock()
    }
